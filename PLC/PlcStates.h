...
// =============================================================================
// PLC — opcodes TCP (válvulas, errores, estados)
// Ref: Doc/opcode_reference_list.md · tabla PLC · Doc/gpio_list_updated.md
// =============================================================================
...
// --- Errores sensores (esclavo → maestro) ---
enum PlcError : uint8_t {
  PLC_ERR_CUTTER  = 0x1F,  // CutterE()
  PLC_ERR_GRIPPER = 0x20,  // GripperE()
  PLC_ERR_HOLDER  = 0x21,  // HolderE()
  PLC_ERR_ENCODER = 0x22,  // EncoderE()
};
