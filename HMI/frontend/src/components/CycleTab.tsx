...
export const CYCLE_STEPS_DEFINITION: CycleStep[] = [
  { id: 1, title: 'Holder ON (solo 1ª pieza)', type: 'action' },
  ...
  { id: 8, title: 'Holder abre', type: 'action' },
  { id: 9, title: 'Delay tras abrir holder', type: 'delay', delayKey: 'holderOpenMs', defaultDurationMs: 100 },
  ...
  { id: 12, title: 'Holder cierra (pre-corte)', type: 'action' },
