...
<div class="wrap">
  ...
  <section>
    <h2>Test feed · L / R</h2>
    <p style="color:var(--muted);font-size:.82rem;margin:0 0 .75rem">Target fijo 55 mm · Position + Sensor (producción) o Velocity + Sensor (LR-X = tope: OFF→Slow, ON→Halt inmediato). Purga/refill sigue en Position.</p>
